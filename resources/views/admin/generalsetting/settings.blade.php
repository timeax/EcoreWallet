    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{ __('KYC Offer Limit') }} <i class="fas fa-info-circle" data-toggle="tooltip" title="@langg('User can create offer you put the number here, if they are not KYC verified. Put 0 for no limit.')"></i></label>
                    <div class="col-sm-9">
