...
var CarouselItem = React4.memo(function(props) {
  ...
  return React4.createElement("div", itemClonedProps, content);
});
var Carousel = React4.memo(React4.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React4.useContext(PrimeReactContext);
  var props = CarouselBase.getProps(inProps, context);
  var _React$useState = React4.useState(props.numVisible), _React$useState2 = _slicedToArray(_React$useState, 2), numVisibleState = _React$useState2[0], setNumVisibleState = _React$useState2[1];
  var _React$useState3 = React4.useState(props.numScroll), _React$useState4 = _slicedToArray(_React$useState3, 2), numScrollState = _React$useState4[0], setNumScrollState = _React$useState4[1];
  var _React$useState5 = React4.useState(props.page * props.numScroll * -1), _React$useState6 = _slicedToArray(_React$useState5, 2), totalShiftedItemsState = _React$useState6[0], setTotalShiftedItemsState = _React$useState6[1];
  var _React$useState7 = React4.useState(props.page), _React$useState8 = _slicedToArray(_React$useState7, 2), pageState = _React$useState8[0], setPageState = _React$useState8[1];
  ...
  var itemsContainerRef = React4.useRef(null);
  var remainingItems = React4.useRef(0);
  var allowAutoplay = React4.useRef(!!props.autoplayInterval);
  var attributeSelector = React4.useRef("");
  var swipeThreshold = React4.useRef(20);
  var startPos = React4.useRef(null);
  var interval = React4.useRef(null);
  var carouselStyle = React4.useRef(null);
  var indicatorContent = React4.useRef(null);
  var isRemainingItemsAdded = React4.useRef(false);
  var responsiveOptions = React4.useRef(null);
    ...
    if (props.value && props.value.length) {
      ...
      if (isCircular) {
        ...
        clonedItemsForStarting = clonedElements.map(function(item2, index) {
          ...
          return React4.createElement(CarouselItem, {
            key,
      ...
      return React4.createElement(React4.Fragment, null, clonedItemsForStarting, items, clonedItemsForFinishing);
    }
  };
  var createHeader = function createHeader2() {
    if (props.header) {
      ...
      return React4.createElement("div", headerProps, props.header);
    }
    return null;
  };
  var createFooter = function createFooter2() {
    if (props.footer) {
      ...
      return React4.createElement("div", footerProps, props.footer);
    }
    return null;
  };
  var createContent = function createContent2() {
    ...
    return React4.createElement("div", containerProps, backwardNavigator, React4.createElement("div", itemsContentProps, React4.createElement("div", _extends4({
  ...
  var createBackwardNavigator = function createBackwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.prevIcon || React4.createElement(ChevronUpIcon, previousButtonIconProps) : props.prevIcon || React4.createElement(ChevronLeftIcon, previousButtonIconProps);
      ...
      return React4.createElement("button", previousButtonProps, backwardNavigatorIcon, React4.createElement(Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.nextIcon || React4.createElement(ChevronDownIcon, nextButtonIconProps) : props.nextIcon || React4.createElement(ChevronRightIcon, nextButtonIconProps);
      ...
      return React4.createElement("button", nextButtonProps, forwardNavigatorIcon, React4.createElement(Ripple, null));
    }
    return null;
  };
  ...
  var createIndicator = function createIndicator2(index) {
    ...
    return React4.createElement("li", indicatorProps, React4.createElement("button", indicatorButtonProps, React4.createElement(Ripple, null)));
  };
  var createIndicators = function createIndicators2() {
    if (props.showIndicators) {
      ...
      return React4.createElement("ul", indicatorsProps, _indicators);
    }
    return null;
  };
  ...
  return React4.createElement("div", rootProps, header, React4.createElement("div", contentProps, content, indicators), footer);
}));
