...
var CarouselItem = React2.memo(function(props) {
  ...
  return React2.createElement("div", itemClonedProps, content);
});
var Carousel = React2.memo(React2.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React2.useContext(PrimeReactContext);
  var props = CarouselBase.getProps(inProps, context);
  var _React$useState = React2.useState(props.numVisible), _React$useState2 = _slicedToArray(_React$useState, 2), numVisibleState = _React$useState2[0], setNumVisibleState = _React$useState2[1];
  var _React$useState3 = React2.useState(props.numScroll), _React$useState4 = _slicedToArray(_React$useState3, 2), numScrollState = _React$useState4[0], setNumScrollState = _React$useState4[1];
  var _React$useState5 = React2.useState(props.page * props.numScroll * -1), _React$useState6 = _slicedToArray(_React$useState5, 2), totalShiftedItemsState = _React$useState6[0], setTotalShiftedItemsState = _React$useState6[1];
  var _React$useState7 = React2.useState(props.page), _React$useState8 = _slicedToArray(_React$useState7, 2), pageState = _React$useState8[0], setPageState = _React$useState8[1];
  ...
  var itemsContainerRef = React2.useRef(null);
  var remainingItems = React2.useRef(0);
  var allowAutoplay = React2.useRef(!!props.autoplayInterval);
  var attributeSelector = React2.useRef("");
  var swipeThreshold = React2.useRef(20);
  var startPos = React2.useRef(null);
  var interval = React2.useRef(null);
  var carouselStyle = React2.useRef(null);
  var indicatorContent = React2.useRef(null);
  var isRemainingItemsAdded = React2.useRef(false);
  var responsiveOptions = React2.useRef(null);
    ...
    if (props.value && props.value.length) {
      ...
      if (isCircular) {
        ...
        clonedItemsForStarting = clonedElements.map(function(item2, index) {
          ...
          return React2.createElement(CarouselItem, {
            key,
      ...
      return React2.createElement(React2.Fragment, null, clonedItemsForStarting, items, clonedItemsForFinishing);
    }
  };
  ...
  var createContent = function createContent2() {
    ...
    return React2.createElement("div", containerProps, backwardNavigator, React2.createElement("div", itemsContentProps, React2.createElement("div", _extends2({
  ...
  var createBackwardNavigator = function createBackwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.prevIcon || React2.createElement(ChevronUpIcon, previousButtonIconProps) : props.prevIcon || React2.createElement(ChevronLeftIcon, previousButtonIconProps);
      ...
      return React2.createElement("button", previousButtonProps, backwardNavigatorIcon, React2.createElement(Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.nextIcon || React2.createElement(ChevronDownIcon, nextButtonIconProps) : props.nextIcon || React2.createElement(ChevronRightIcon, nextButtonIconProps);
      ...
      return React2.createElement("button", nextButtonProps, forwardNavigatorIcon, React2.createElement(Ripple, null));
    }
    return null;
  };
  ...
  var createIndicator = function createIndicator2(index) {
    ...
    return React2.createElement("li", indicatorProps, React2.createElement("button", indicatorButtonProps, React2.createElement(Ripple, null)));
  };
  var createIndicators = function createIndicators2() {
    if (props.showIndicators) {
      ...
      return React2.createElement("ul", indicatorsProps, _indicators);
    }
    return null;
  };
  ...
  return React2.createElement("div", rootProps, header, React2.createElement("div", contentProps, content, indicators), footer);
}));
